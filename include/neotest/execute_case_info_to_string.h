...
R"({
    ...
    "runtime check passed rate":{},
    "runtime assert total":{},
    "runtime assert passed":{},
    "runtime assert failed":{},
    "runtime assert passed rate":{},
    "is passed":{},
    "is failed":{},
    "is skipped":{},
    "is undefined":{}
        ...
        ,ei.get_duration_string()
        ,ei.get_runtime_check_total()
        ,ei.get_runtime_check_passed()
        ,ei.get_runtime_check_failed()
        ,ei.get_runtime_check_passed_rate()
        ,ei.get_runtime_assert_total()
        ,ei.get_runtime_assert_passed()
        ,ei.get_runtime_assert_failed()
